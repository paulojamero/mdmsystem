...
// $to_email = "delosreyesnadine@gmail.com";
// $subject = "Simple Email Test via PHP";
// $body = "Hi Nee, This is test email send by PHP Script";
// $headers = "From: mdmit1970@gmail.com";
...
switch (@$_GET['do'])
 ...
 case "send":
    ...
    if ($secretinfo == "")
    {
       $myemail = "it@mdm.edu.ph";  //Email receiver
